 ...
 */
public class UsuarioAdminForm extends FormLayout {
    ...
    public UsuarioAdminForm(UsuarioAdminCrudLogic usuarioAdminCrudLogic, List<CategoriaProducto> listCategoria) {
        ...
        viewLogic = usuarioAdminCrudLogic;
