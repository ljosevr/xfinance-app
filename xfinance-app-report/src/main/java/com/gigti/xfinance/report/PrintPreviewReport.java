package com.gigti.xfinance.report;
...
public class PrintPreviewReport<T> extends Composite<VerticalLayout> {
    ...
    public enum Format {
        PDF(JRPdfExporter::new, os -> new SimpleOutputStreamExporterOutput(os)),
    ...
    public PrintPreviewReport(Class<T> type) {
        this();
        BeanPropertySet<T> propertySet = (BeanPropertySet<T>) BeanPropertySet.get(type);
